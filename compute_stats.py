...
def run_nuclei_inst_stat(pred_dir, true_dir, print_img_stats=False, ext='.mat'):
    ...
    metrics = np.where(np.isfinite(metrics),metrics,0)
...
if __name__ == '__main__':
    ...
    if args.mode == 'instance':
        run_nuclei_inst_stat("/home/test/GhulamMurtaza/hover_net/src/output/v1.0/np_hv/_proc/", "/home/test/GhulamMurtaza/panNuke/Test/Labels/", print_img_stats=True)
    if args.mode == 'type':
        run_nuclei_type_stat("/home/test/GhulamMurtaza/hover_net/src/output/v1.0/np_hv/_proc/", "/home/test/GhulamMurtaza/hover_net-master (1)/hover_net-master/src/GroundTruth/dump/")
